...
export const posts: PostType[] = [
  {
    ...
    date: new Date("9/27/25"),
    slug: "brawl-stars",
    content:
      "Brawl Stars, an online multiplayer battle game made by Supercell, is my favorite mobile game and possibly my favorite game of all time. It has hundreds of millions of players with multiple game modes, brawlers, maps, and strategies to win. I started playing Brawl Stars in 2020 when a lot of my friends were playing it. Then the game kind of just died and I uninstalled it after only playing for a couple of weeks. In December 2022, I picked it up again because I was bored and had no game on my phone. It was after that when I fell in love with the game and started playing it almost daily for hours, especially on weekends. I love the satisfaction of defeating opponents and winning a game, gaining trophies, collecting resources, unlocking new brawlers and abilities, and progressing my account. A ton of fixes, improvements, and new features were also added to the game during this period, and they started giving out a ton of free rewards, which made me play even more. It was also starting to gain popularity again and almost all my friends started playing the game. I learned a ton of new strategies on certain maps, brawler combos, maneuvers to hit shots/dodge enemies, and how to use each brawler to their fullest potential. When I first started, I was auto-aiming almost everytime, but now I can hit shots with precision and accuracy. Playing with friends either in Ranked or casual friendly matches is a ton of fun and is a huge reason why I play so often. Following the trophy system rework, I was able to push trophies significantly faster, and I now have almost 60k trophies and get to Legendary in every Ranked season. I also have Lunar fame and every brawler unlocked as a free to play. In the summer of 2025, I stayed in Taiwan for 2 months, and due to having limited data and not having my own phone, I barely touched the game this entire time and almost decided to quit it at one point. After I came back, started high school, and finally got my own phone, of course I resumed playing Brawl Stars but not as much as before because hoemwork was starting to stack up and I was getting busier with each new assignment. The game was also declining in popularity and many of my friends stopped playing the game. Now, the only time I play it is on the 40 minute bus rides when I'm not doomscrolling on TikTok.",
  },
  {
    id: 1,
    title: "My Experience with HTML",
    date: new Date("9/19/25"),
    slug: "html-experience",
    content:
      "Hyper Text Markup Language, or HTML, is literally the foundation of the internet and the web. It is the backbone of a website and it contains all the content on a web page. It is one of the three foundational languages (along with CSS and JavaScript) that make up a website. Every website I've ever made, every web page I've ever written, I started with HTML. It's the first language I truly learned and mastered, and it's where all the creativity comes from. It is truly special to me. Back in the Christmas of 2020, my parents bought me the book that changed me forever. The Wizards of the Programming Island first introduced me to web development, and the first thing it taught me was HTML. I followed its examples, tried it on coding playgrounds, looked up different resources, learned more techniques... and just like that, I got completely hooked up with web development. I started going on amazing websites like W3Schools and Sololearn and so many more, eager to learn more HTML, watched hours of YouTube tutorials on HTML projects, and finally, after nearly 3 years of experimenting, failing, and learning, I mastered HTML. I liked it so much I even used it to make websites for my school projects! After so many years into web development, I'm still relying on the special language a lot. Looking back on this journey, I'm grateful that my parents bought me that book 🔥.",
    // headings: [
