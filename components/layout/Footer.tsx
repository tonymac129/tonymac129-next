...
function Footer() {
  return (
    <div className="border-t-2 border-zinc-500 dark:border-zinc-800 flex flex-col items-center gap-y-5 py-15 px-5">
      <span className="text-sm text-zinc-800 dark:text-zinc-300 text-center">
      ...
      <div className="text-zinc-800 dark:text-zinc-300 flex flex-wrap justify-center gap-x-7 gap-y-5 mt-5">
